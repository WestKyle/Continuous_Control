...
UPDATE_FREQ = 20        # Update the model parameters every 1 in UPDATE_FREQ cycles
UPDATE_NUM = 10         # Number of model parameter updates per cycle
...
class Agent():
    ...
    def step(self, states, actions, rewards, next_states, dones):
        ...
        # For 20 agent environment, there are 20 of these to push into memory
